...
export const PORTFOLIO_DEFAULTS = {
  ...
  states: {
    CA: {
      ...
      recProgram: 'California has a voluntary REC market: RECs from commercial rooftop and carport projects can be sold through bilateral agreements or included in the value package provided to the tenant. No standardised state-administered purchase contract is available for ordinary C&I projects.',
    ...
    IL: {
      ...
      marketPosition: 'Illinois has moderate commercial electricity prices and the weakest solar resource score in the portfolio. The market remains attractive because Illinois Shines can provide contracted REC revenue that is not available in the other states — an attractive opportunity to consider where REC capacity, a clean interconnection path and a suitable customer load profile align.',
    ...
    NC: {
      ...
      devConsiderations: 'A compliant structure is an equipment lease to the tenant, who remains the utility customer and owns the electrical output. The lessor must obtain an NCUC certificate, register each facility, serve one lessee at one premises and comply with required lease terms. Alternative structures can be considered but add complexity to the development process.',
      projectsIntro: '',
      screeningNote: SCREENING_NOTE,
    },
    TX: {
      ...
      recProgram: 'ERCOT, the Texas grid operator, administers a statewide REC trading program, and eligible producers may register to earn and trade RECs. Credits can be monetised through bilateral sale or included in the value package provided to the tenant; Texas does not offer a state-administered fixed-price purchase program for ordinary C&I rooftop projects.',
