// Further-detailed-analysis categories. Rendered per asset in a standalone
// report, and once at document level in the compiled portfolio.
export const TECHNICAL_ITEMS = [
  { category: 'Electrical Load Analysis', notes: 'Assess site electrical loads and consumption profiles to confirm buildable capacity and interconnection approach' },
