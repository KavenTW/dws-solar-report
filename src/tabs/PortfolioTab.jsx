          ...
          <div className="portfolio-editor-grid">
            <div className="portfolio-editor-col">
              ...
              <button
                ...
                onClick={async () => {
                  if (window.confirm(`Load / update the DWS portfolio data (${DWS_DATASET_LABEL})?\n\nExisting saved projects get updated sizing, production, site notes and roof years — images you uploaded yourself and other edits are preserved. Missing projects are created. Layout images come from the deploy and need no loading.`)) {
