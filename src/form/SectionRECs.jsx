...
export default function SectionRECs() {
  ...
  return (
    <SectionWrapper title="Renewable Energy Certificates (RECs)" hasErrors={hasErrors} headerExtras={<SectionToggleChip flagKey="showRECsSection" label="RECs" />} collapseWhen={!p.showRECsSection}>
